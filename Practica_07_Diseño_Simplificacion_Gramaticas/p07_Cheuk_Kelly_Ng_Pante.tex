...
\begin{itemize}
  ...
  \begin{itemize}
    \item \( S \rightarrow [A] \ \mid \ [] \)
    \item \( A \rightarrow B \ \mid \ B, A \)
    \item \( B \rightarrow S \ \mid \ 0 \ \mid \ 1 \ \mid \ 2 \ \mid \ 3 \ \mid \ 4 \ \mid \ 5 \ \mid \ 6 \ \mid \ 7 \ \mid \ 8 \ \mid \ 9 \)
  \end{itemize}
  \item \textbf{Imagen de la gramática en JFLAP:} La gramática diseñada en JFLAP se muestra en la siguiente figura:
  \begin{figure}[H]
    \centering
...
\begin{itemize}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{img/grammar_mod.png}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \begin{figure}[H]
        \centering
        \includegraphics[scale=0.45]{img/grammar_mod_tree_1.png}
    ...
    \begin{itemize}
      ...
      \begin{figure}[H]
        \centering
        \includegraphics[scale=0.5]{img/grammar_mod_tree_2.png}
    ...
    \begin{itemize}
      ...
      \begin{figure}[H]
        \centering
        \includegraphics[scale=0.5]{img/grammar_mod_tree_3.png}
  ...
  \begin{figure}[H]
    \centering
      \includegraphics[scale=0.45]{img/grammar_mod_simplified.png}
